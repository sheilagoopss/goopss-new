    ...
    <section className={`w-full py-16 md:py-24 ${openSansHebrew.variable} font-sans`} dir="rtl">
      <div className="container mx-auto px-4 md:px-0">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center w-full">
          {/* Pink Card with Blob */}
          <div className="relative rounded-3xl p-0 md:p-0 order-2 md:order-1 overflow-hidden md:w-7/12 w-full h-full min-h-full" style={{background: 'linear-gradient(135deg, #FFE0F7 0%, #FFD0F0 100%)'}}>
            {/* Blob SVG */}
          ...
          <div className="relative flex flex-col items-center justify-center order-1 md:order-2 rounded-3xl p-0 md:p-0 overflow-hidden md:w-5/12 w-full h-full min-h-full" style={{background: 'linear-gradient(135deg, #F1FFB0 0%, #D8F5A2 100%)'}}>
            {/* Blob SVG */}
